interface ComponentsIconProps {
  className?: string;
  size?: number;
}

export function ComponentsIcon({ className, size = 18 }: ComponentsIconProps) {
  return (
    <svg
