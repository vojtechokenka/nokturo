...
-- Creates accounting tables and invoices bucket for the Účetnictví (Accounting) tab

-- Accounting categories (editable like supplier_categories)
...
-- Invoices bucket for PDF uploads
...
DROP TRIGGER IF EXISTS trg_accounting_orders_updated_at ON public.accounting_orders;
CREATE TRIGGER trg_accounting_orders_updated_at
  BEFORE UPDATE ON public.accounting_orders
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();

-- Seed default accounting categories
